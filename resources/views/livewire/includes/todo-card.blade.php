<div wire:key='{{ $todo-> id }}' class="todo mb-5 card px-5 py-6 bg-white dark:bg-gray-900 col-span-1 border-t-2 border-blue-500 hover:shadow">
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex items-center">
            ...
            @if ($editingTodoID === $todo->id)
                ...
                @else
                    <h3 class="text-lg text-semibold text-gray-800 dark:text-white">{{ $todo->name }}</h3>
            @endif
        ...
        <div class="flex items-center space-x-2">
            ...
            <button wire:click='delete({{ $todo->id }})' class="text-sm text-red-500 font-semibold rounded hover:text-red-800 mr-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-4 h-4">
                    <path stroke-linecap="round" stroke-linejoin="round"
